...
void gui_setup( void ) {
     ...
     */
  log_i("entering battery_settings_tile_setup();");
    battery_settings_tile_setup();

      log_i("entering display_settings_tile_setup();");
    display_settings_tile_setup();

      log_i("entering move_settings_tile_setup();");
    move_settings_tile_setup();

      log_i("entering style_settings_tile_setup();");
    style_settings_tile_setup();

    log_i("entering wlan_settings_tile_setup();");
    wlan_settings_tile_setup();

        log_i("time_settings_tile_setup();");
    time_settings_tile_setup();
  //  gps_settings_tile_setup();

            log_i(" utilities_tile_setup();");
    utilities_tile_setup();

       log_i(" sound_settings_tile_setup();");
